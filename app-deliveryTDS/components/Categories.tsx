...
const categories: Category[] = [
  ...
  { name: 'Pará Lanches', image: 'https://pbs.twimg.com/profile_images/1652312708623089666/kxWH82E6_400x400.jpg' },
];
...
// Define o componente funcional `Categories`.
  ...
  // Função chamada quando o usuário clica em uma categoria.
    ...
    if (name === 'Pará Lanches') {
      router.push('/(tabs)/screens/paraLanches');
    }
  };
